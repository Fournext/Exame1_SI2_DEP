"""
Django settings for api_TiendaIA project.
...
SECRET_KEY = 'django-insecure-wzdqg)&zj($*j+78guu-olg!sdlra^!l11z^0q6ho*8g)wb$4+'
...
WSGI_APPLICATION = 'api_TiendaIA.wsgi.application'
